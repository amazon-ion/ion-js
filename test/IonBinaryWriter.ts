...
let decimalWriterTests: Test[] = [
  ...
  },
  {
    ...
    instructions: (writer) =>
      writer.writeDecimal(ion.Decimal.parse("123456000")),
...
let intWriterTests: Test[] = [
  ...
  },
  {
    ...
    instructions: (writer) => writer.writeInt(0n),
    expected: [0x20],
  },
  {
    name: "Writes BigInt 12345678901234567890",
    instructions: (writer) => writer.writeInt(BigInt("12345678901234567890")),
...
let timestampWriterTests: Test[] = [
  ...
  },
  {
    ...
    instructions: (writer) => {
      writer.writeTimestamp(
        new ion.Timestamp(0, 2000, 1, 1, 12, 34, ion.Decimal.parse("56.789"))
      );
    },
    expected: [
      0x6b,
  ...
  },
  {
    ...
    instructions: (writer) => {
      writer.writeTimestamp(
        new ion.Timestamp(-8 * 60, 2000, 1, 1, 12, 34, ion.Decimal.parse("0"))
      );
    },
    expected: [0x69, 0x43, 0xe0, 0x0f, 0xd0, 0x81, 0x81, 0x94, 0xa2, 0x80],
  },
];
...
let badWriterTests: BadTest[] = [
  ...
  {
    name:
      "Should throw when passing annotations array containing a non string value.",
    instructions: (writer) => {
      // @ts-ignore
...
describe("Binary Writer", () => {
  ...
  it("Calculates node lenghts correctly", () => {
    ...
    let node = new NullNode(
      writer,
      null,
      ion.IonTypes.LIST,
      new Uint8Array([10 | 0x80])
    );
